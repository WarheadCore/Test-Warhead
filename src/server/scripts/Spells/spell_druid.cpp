...
class spell_dru_nurturing_instinct : public AuraScript
{
    ...
    void AfterApply(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
    {
        if (Player* player = GetTarget()->ToPlayer())
            player->AddSpell(GetSpellInfo()->GetRank() == 1 ? SPELL_DRUID_NURTURING_INSTINCT_R1 : SPELL_DRUID_NURTURING_INSTINCT_R2, false, true, false, false, 0);
    }
...
void AddSC_druid_spell_scripts()
{
    ...
    RegisterAuraScript(spell_dru_nurturing_instinct);
}
