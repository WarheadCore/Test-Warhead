...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_SEL_BAN_INFO_BY_NAME, "SELECT character_banned.bandate, character_banned.unbandate, character_banned.bannedby, character_banned.banreason FROM character_banned, characters WHERE characters.name = ? AND character_banned.guid = characters.guid AND character_banned.bandate = character_banned.unbandate OR character_banned.unbandate > UNIX_TIMESTAMP()", CONNECTION_SYNCH);
