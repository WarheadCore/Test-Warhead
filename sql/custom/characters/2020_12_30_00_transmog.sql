...
CREATE TABLE IF NOT EXISTS `custom_transmogrification` (
        ...
        PRIMARY KEY (`GUID`),
        KEY `Owner` (`Owner`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = '6_2';
...
CREATE TABLE `custom_transmogrification_sets` (
    ...
    `SetName` text CHARACTER
    SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'SetName',
    `SetData` text CHARACTER
    SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Slot1 Entry1 Slot2 Entry2',
