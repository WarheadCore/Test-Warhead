...
CREATE TABLE `account` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `idx_username` (`username`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Account System';
...
CREATE TABLE `account_access` (
    ...
    PRIMARY KEY (`AccountID`, `RealmID`)) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `account_banned` (
    ...
    PRIMARY KEY (`id`, `bandate`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Ban List';
...
CREATE TABLE `account_muted` (
    ...
    PRIMARY KEY (`guid`, `mutedate`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'mute List';
...
CREATE TABLE `autobroadcast` (
    ...
    PRIMARY KEY (`id`, `realmid`)) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `build_info` (
    ...
    PRIMARY KEY (`build`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `ip_banned` (
    ...
    PRIMARY KEY (`ip`, `bandate`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Banned IPs';
...
CREATE TABLE `logs` (
    ...
    SET latin1) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `logs_ip_actions` (
    ...
    PRIMARY KEY (`id`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Used to log ips of individual actions';
...
CREATE TABLE `rbac_account_permissions` (
    ...
    CONSTRAINT `fk__rbac_account_roles__rbac_permissions` FOREIGN KEY (`permissionId`) REFERENCES `rbac_permissions` (`id`) ON DELETE CASCADE) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Account-Permission relation';
...
CREATE TABLE `rbac_default_permissions` (
    ...
    CONSTRAINT `fk__rbac_default_permissions__rbac_permissions` FOREIGN KEY (`permissionId`) REFERENCES `rbac_permissions` (`id`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Default permission to assign to different account security levels';
...
INSERT INTO `rbac_default_permissions`
        VALUES (3, 192, - 1), (2, 193, - 1), (1, 194, - 1), (0, 195, - 1);
...
CREATE TABLE `rbac_linked_permissions` (
    ...
    CONSTRAINT `fk__rbac_linked_permissions__rbac_permissions2` FOREIGN KEY (`linkedId`) REFERENCES `rbac_permissions` (`id`) ON DELETE CASCADE) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Permission - Linked Permission relation';
...
CREATE TABLE `rbac_permissions` (
    ...
    PRIMARY KEY (`id`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Permission List';
...
CREATE TABLE `realmcharacters` (
    ...
    KEY `acctid` (`acctid`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Realm Character Tracker';
...
CREATE TABLE `realmlist` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `idx_name` (`name`)) ENGINE = InnoDB AUTO_INCREMENT = 2 DEFAULT CHARSET = utf8 COMMENT = 'Realm System';
...
INSERT INTO `realmlist`
        VALUES (1, 'Trinity', '127.0.0.1', '127.0.0.1', '255.255.255.0', 8085, 0, 2, 1, 0, 0, 12340);
...
CREATE TABLE `updates` (
    ...
    `state` enum ('RELEASED',
        'ARCHIVED') NOT NULL DEFAULT 'RELEASED' COMMENT 'defines if an update is released or archived.',
    `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'timestamp when the query was applied.',
    `speed` int (10) unsigned NOT NULL DEFAULT '0' COMMENT 'time the query takes to apply in ms.',
    PRIMARY KEY (`name`)) ENGINE = MyISAM DEFAULT CHARSET = utf8 COMMENT = 'List of all applied updates in this database.';
...
CREATE TABLE `updates_include` (
    ...
    `state` enum ('RELEASED',
        'ARCHIVED') NOT NULL DEFAULT 'RELEASED' COMMENT 'defines if the directory contains released or archived updates.',
    PRIMARY KEY (`path`)) ENGINE = MyISAM DEFAULT CHARSET = utf8 COMMENT = 'List of directories where we want to include sql updates.';
...
INSERT INTO `updates_include`
        VALUES ('$/sql/updates/auth', 'RELEASED'), ('$/sql/custom/auth', 'RELEASED'), ('$/sql/old/3.3.5a/auth', 'ARCHIVED');
...
CREATE TABLE `uptime` (
    ...
    PRIMARY KEY (`realmid`, `starttime`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = 'Uptime system';
